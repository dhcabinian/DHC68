...
for hw in hardware_table:
    ...
    with open(os.path.join(templates_dir, template_name), 'w') as outfile:
        ...
        #David added
        outfile.write("\nrgb_underglow_map = ")
        write_symbol(outfile, symbols, 'rgb_underglow_led_const')
        outfile.write("\nrgb_underglow_count = ")
        write_symbol(outfile, symbols, 'rgb_underglow_count_const')
        outfile.write("\nrgb_underglow_pin = ")
        write_symbol(outfile, symbols, 'rgb_underglow_pin_const')
        outfile.write("\n")
